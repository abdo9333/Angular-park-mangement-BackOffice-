...
// image 
  ...
  uploadProfileImage(formData: FormData): Observable<any> {
    return this.http.post<FormData>('http://192.168.33.10:3002/trees/3/upload/', formData, {
      reportProgress: true,
      observe: 'events'
    })
  }
  /*
  updateOne(tree:any): Observable<Tree> {
    return this.http.put('http://192.168.33.10:3002/trees/updateOne/3', tree);
  }*/
